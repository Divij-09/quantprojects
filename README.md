...
Pulls data from all sheets to create well-organized, formatted tables with counts for unique values (including blanks) and places them in a designated spot within the workbook.

## Excel Integration: 
Uses OpenPyXL to seamlessly add charts and tables to a "Summary" sheet, keeping everything in one place without disrupting the original data.
